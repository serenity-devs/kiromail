...
INSERT INTO campaigns (id, name, subject, preview_text, from_name, from_email, reply_to, template_id, target_type, target_id, status, scheduled_at, started_at, completed_at, total_recipients, sent_count, delivered_count, open_count, click_count, bounce_count, complaint_count, unsubscribe_count, created_at) VALUES
  ('60000000-0000-4000-8000-000000000001', 'Cuaderno de julio', 'Cinco ideas para un verano más lento', 'Nuestra selección mensual.', 'Serenity Studio', 'hola@serenity.local', 'hola@serenity.local', '50000000-0000-4000-8000-000000000001', 'list', '10000000-0000-4000-8000-000000000002', 'completed', now() - interval '24 days', now() - interval '24 days', now() - interval '24 days' + interval '8 minutes', 1248, 1248, 1219, 718, 164, 29, 1, 6, now() - interval '28 days'),
  ('60000000-0000-4000-8000-000000000002', 'Bienvenida a la temporada', 'Septiembre empieza aquí', 'Una pequeña vuelta a lo esencial.', 'Serenity Studio', 'hola@serenity.local', 'hola@serenity.local', '50000000-0000-4000-8000-000000000002', 'all', NULL, 'scheduled', now() + interval '3 days', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, now() - interval '2 days'),
  ('60000000-0000-4000-8000-000000000003', 'Clientes: avance privado', 'Un vistazo antes que nadie', '', 'Serenity Studio', 'hola@serenity.local', 'hola@serenity.local', '50000000-0000-4000-8000-000000000002', 'segment', '40000000-0000-4000-8000-000000000001', 'draft', NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, now() - interval '1 day')
ON CONFLICT (id) DO NOTHING;
