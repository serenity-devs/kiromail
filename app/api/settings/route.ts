...
const schema = z.object({
  organization_name: z.string().trim().min(1), default_from_name: z.string().trim().min(1), default_from_email: z.email(), default_reply_to: z.email(),
